...
{
	[Library]
	public partial class MiniWalkController : BasePlayerController
	{
		[Net] public float SprintSpeed { get; set; } = 32.0f;
		[Net] public float WalkSpeed { get; set; } = 90.0f;
		[Net] public float DefaultSpeed { get; set; } = 19.0f;
		...
		[Net] public float Size { get; set; } = 2.0f;
